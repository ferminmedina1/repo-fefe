...
const DEFAULT_MODULES: PermissionModule[] = [
  ...
  { code: "customer_support", name: "Atención al Cliente", category: "Clientes" },
  { code: "products", name: "Productos", category: "Inventario" },
  { code: "inventory_alerts", name: "Alertas de Inventario", category: "Inventario" },
  { code: "warehouses", name: "Depósitos", category: "Inventario" },
  { code: "warehouse_stock", name: "Stock por Depósito", category: "Inventario" },
  ...
  { code: "purchase_orders", name: "Órdenes de Compra", category: "Compras" },
  { code: "purchase_reception", name: "Recepción de Mercadería", category: "Compras" },
  ...
  { code: "audit_logs", name: "Auditoría", category: "Administración" },
  { code: "access_logs", name: "Logs de Acceso", category: "Administración" },
  { code: "monthly_closing", name: "Cierre Mensual", category: "Administración" },
  { code: "notifications", name: "Notificaciones", category: "Administración" },
  ...
  { code: "afip", name: "Facturación AFIP", category: "Integraciones" },
