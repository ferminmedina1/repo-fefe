        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm">
          <div className="min-h-screen flex items-start justify-end">
            <div className="w-full max-w-xl bg-white dark:bg-slate-950 rounded-l-2xl shadow-2xl flex flex-col h-screen">
              <div style={gradientStyle} className="backdrop-blur-md border-b border-white/10 px-6 py-5 flex justify-between items-center rounded-tl-2xl">
              ...
              <div style={contentGradientStyle} className="flex-1 overflow-y-auto p-6 space-y-6 dark:bg-slate-900">
                {loading ? (
