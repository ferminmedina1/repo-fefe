...
export const TUTORIAL_MODULES: ModuleTutorial[] = [
  // ── Ventify: Introducción Completa ────────────────────────────────
  {
    moduleId: 'ventify_intro',
    moduleName: 'Qué es Ventify',
    description: 'Descubre Ventify: Tu plataforma profesional de gestión de ventas y negocios',
    category: 'Inicio',
    estimatedTime: 8,
    icon: 'Sparkles',
    route: '/app',
    steps: [
      {
        ...
        description: 'Ventify es tu asistente administrativo en la computadora. Registra cada venta, te muestra quién debe, qué productos vender más, y te alerta cuándo el stock baja. Todo automático, sin Excel, sin confusión.',
        position: 'bottom',
        action: 'Continúa aprendiendo qué puedes hacer',
        duration: 2,
      },
      {
        id: 'ventify-2',
        blockName: 'Los 3 Pilares de tu Negocio',
        title: '💡 Cómo Pensa el Sistema',
        description: 'Tu negocio en Ventify se divide en 3 pilares conectados: (1) VENTAS - Qué vende (POS/Órdenes), (2) INVENTARIO - Qué tienes (Productos/Stock), (3) DINERO - Cuánto ganas (Finanzas/Reportes). Cada acción en uno afecta a los otros. Todo integrado.',
        position: 'bottom',
        action: 'Observa cómo estos 3 pilares trabajan juntos',
        duration: 3,
      },
      {
        id: 'ventify-3',
        blockName: 'Principio 1: El Flujo del Dinero',
        title: '💰 Todo está Conectado',
        description: 'Cuando haces una venta: (1) El dinero entra en tu cuenta, (2) El stock del producto baja automáticamente, (3) El cliente se registra en tu base, (4) Tu Dashboard actualiza al instante. Cero pasos manuales. Ventify lo hace por ti.',
        position: 'bottom',
        action: 'Piensa: una venta = múltiples datos automáticos',
        duration: 3,
      },
      {
        id: 'ventify-4',
        blockName: 'Principio 2: Los Datos son tu Aliado',
        title: '📊 Información en Tiempo Real',
        description: 'Cada transacción genera un dato. Ventify agrupa esos datos. Tú ves patrones: qué vende más, cuándo, a quién. Decides mejor. Reduces gastos. Aumentas ganancias. Todo basado en números, no en intuición.',
        position: 'bottom',
        action: 'Confía en los datos, no en suposiciones',
        duration: 2,
      },
      {
        id: 'ventify-5',
        blockName: 'Principio 3: Nada se Pierde',
        title: '🔒 Historial Completo y Auditoría',
        description: 'Cada movimiento queda registrado: quién hizo qué, cuándo, dónde. Revisas una venta de hace 6 meses en 5 segundos. Auditoría total para transparencia y cumplimiento legal. Cero "me lo robaron", cero "qué pasó?".',
        position: 'bottom',
        action: 'Siente la seguridad de saber TODO está guardado',
        duration: 2,
      },
      {
        id: 'ventify-6',
        blockName: 'Los Módulos de Ventify',
        title: '🏢 Tu Centro de Comando',
        description: 'Ventify tiene 6 módulos principales. En la barra izquierda verás: POS (venta rápida), Ventas (órdenes), Clientes (base de datos), Productos (catálogo), Finanzas (dinero), Reportes (análisis). Cada uno es especial pero todos conectados.',
        position: 'bottom',
        action: 'Mira la barra izquierda y reconoce cada módulo',
        duration: 2,
      },
      {
        id: 'ventify-7',
        blockName: 'Explicación: POS vs Ventas',
        title: '📱 ¿Cuándo Usas POS vs Ventas?',
        description: 'POS es para venta rápida (cliente llega, compra al instante). Ventas es para órdenes complejas (múltiples productos, entrega futura, múltiples entregas). POS = 30 segundos. Ventas = 2 minutos. Elige según necesidad.',
        position: 'bottom',
        action: 'Recuerda: POS rápido, Ventas complejo',
        duration: 2,
      },
      {
        id: 'ventify-8',
        blockName: 'Dashboard Principal',
        title: '👁️ Tu Dashboard: El Corazón de Ventify',
        description: 'Cuando abres Ventify, esto es lo primero que ves. Las 4 tarjetas superiores te dicen: (1) Vendiste $X hoy, (2) Tu margen es Y%, (3) Los clientes te deben $Z, (4) Tienes $W en caja. Abajo, gráficas de tendencias y alertas de stock bajo.',
        position: 'bottom',
        action: 'Dirígete al Dashboard para ver en tiempo real',
        duration: 3,
        route: '/app',
      },
      {
        ...
        description: 'Las 4 tarjetas del Dashboard muestran: (1) Ventas del Mes - ingresos totales, (2) Margen Bruto % - ganancia neta, (3) Por Cobrar - deuda de clientes, (4) Saldo Caja - dinero disponible. Cada una tiene un badge % mostrando cambio vs mes anterior.',
        position: 'bottom',
        action: 'Haz clic en una tarjeta para ver detalles históricos',
        duration: 3,
      },
      {
        id: 'ventify-10',
        blockName: 'Clientes y Crédito',
        title: '👥 Tu Base de Clientes',
        description: 'En Módulo Clientes ves: quién compra, cuánto debe, cuánto gastó en total (lifetime value), últimas compras. Ventify te avisa si un cliente supera su límite de crédito. Vendes con inteligencia, no en ciego.',
        position: 'bottom',
        action: 'Explora el módulo Clientes cuando termines',
        duration: 2,
      },
      {
        id: 'ventify-11',
        blockName: 'Productos e Inventario',
        title: '📦 Tu Catálogo y Stock',
        description: 'En Módulo Productos ves: nombre, código (SKU), precio costo, precio venta, stock actual. Ventify calcula el margen automáticamente. Si stock < mínimo configurado, te alerta. Nunca te sorprenderá un producto agotado.',
        position: 'bottom',
        action: 'Sube tu catálogo cuando estés listo',
        duration: 2,
      },
      {
        id: 'ventify-12',
        blockName: 'Finanzas y Análisis',
        title: '💳 Dinero y Decisiones',
        description: 'Finanzas = tu banco dentro de Ventify. Ves ingresos, egresos, saldo. Reportes = análisis: gráficos de tendencias, productos top, clientes top, margen por categoría. Tomas decisiones basadas en números reales, no en intuición.',
        position: 'bottom',
        action: 'Revisa Reportes regularmente para optimizar',
        duration: 2,
      },
      {
        id: 'ventify-13',
        blockName: 'Seguridad y Permisos',
        title: '🔐 Control Total y Seguridad',
        description: 'Puedes crear usuarios con diferentes roles: vendedor (solo vende), gerente (vende + reportes), admin (acceso total). Cada usuario tiene su sesión, su historial, su auditoría. Encriptación end-to-end y respaldos automáticos diarios. Tus datos están súper seguros.',
        position: 'bottom',
        action: 'Agrega más usuarios cuando escales',
        duration: 2,
      },
      {
        id: 'ventify-14',
        blockName: 'Ventajas Resumen',
        title: '⚡ Por Qué Eleggir Ventify',
        description: 'Interfaz intuitiva (sin capacitación larga), escalable (crece contigo), integrado (todo en un lugar), seguro (encriptado), reportes inteligentes (datos en tiempo real), soporte 24/7 (estamos aquí). Resumido: gestiona tu negocio en minutos, crece sin límites.',
        position: 'bottom',
        action: 'Siente la diferencia vs Excel o manual',
        duration: 2,
      },
      {
        id: 'ventify-15',
        blockName: 'Primeros Pasos',
        title: '🎯 Tu Primer Día en Ventify',
        description: 'Sigue estos pasos: (1) Completa Datos de Empresa (logo, nombre), (2) Configura Métodos de Pago (efectivo, tarjeta, crédito), (3) Importa/carga Productos (catálogo), (4) Haz tu Primera Venta (real o simulada), (5) Revisa Dashboard y Reportes. En 20 minutos dominas 80%.',
        position: 'bottom',
        action: 'Comienza en Configuración ahora',
        duration: 3,
        route: '/settings',
      },
      {
        id: 'ventify-16',
        blockName: 'Learning Center y Soporte',
        title: '❓ Nunca Estás Solo',
        description: 'Formas de obtener ayuda: (1) Learning Center - tutoriales interactivos como este, (2) Centro de Soporte - preguntas frecuentes, (3) Chat en vivo - para urgencias, (4) Email - para feedback. Estamos acá para verte crecer.',
        position: 'bottom',
        action: 'Explora el Learning Center para aprender más',
        duration: 2,
      },
    ],
  },
    ...
    steps: [
      {
        ...
        title: '🚚 ¿Qué son los Remitos?',
        description: 'Un remito es el comprobante que acompaña la entrega de mercancías. Usálo cuando: (1) entregás a domicilio, (2) el cliente retira en depósito, o (3) mandás entrega parcial antes de facturar. Cada remito tiene número correlativo, fecha y estado.',
        position: 'bottom',
        action: 'Observá los remitos y sus estados',
      },
      {
        id: 'delivery-2',
        target: '[data-tutorial="btn-create-delivery"]',
        blockName: 'Crear Remito',
        title: '➕ Crear Remito Paso a Paso',
        description: 'Haz clic en Nuevo Remito. El formulario pide: (1) Cliente destinatario, (2) si viene de una venta existente o es independiente, (3) productos y cantidades a entregar, (4) dirección de entrega, (5) fecha pactada. Al confirmar se genera número correlativo automático.',
        position: 'bottom',
      ...
      },
      {
        ...
        title: '📋 Leer la Tabla de Remitos',
        description: 'La tabla muestra: Número correlativo, Fecha, Cliente, Productos, Estado (Pendiente/En camino/Entregado) y Acciones. Filtrá por estado para ver solo los pendientes del día. Hacé clic en un remito para ver el detalle completo o imprimirlo para el repartidor.',
        position: 'top',
      ...
      },
      {
        ...
        description: 'Flujo: Pendiente (no salió) → En camino (salió del local) → Entregado (cliente recibió). También existe Devuelto si el cliente no estaba o rechazó. Al marcar Entregado se registra fecha y hora exacta para tener trazabilidad completa.',
        position: 'left',
    ...
    steps: [
      {
        ...
        title: '📉 ¿Cuándo Usar Devoluciones?',
        description: 'Usá este módulo cuando un cliente devuelve un producto vendido. Al procesar: (1) se restaura el stock automáticamente, (2) se genera nota de crédito para el cliente, (3) se ajusta su cuenta corriente. Siempre necesitás la venta original para iniciar.',
        position: 'bottom',
        action: 'Observa las devoluciones registradas y sus estados',
      },
      {
        id: 'returns-2',
        target: '[data-tutorial="btn-create-return"]',
        blockName: 'Nueva Devolución',
        title: '➕ Cómo Crear una Devolución',
        description: 'Haz clic en Nueva Devolución. Flujo: (1) Buscá la venta original por número o nombre del cliente, (2) el sistema lista los productos de esa venta, (3) elegí cuáles se devuelven y en qué cantidad (no puede superar lo vendido), (4) el importe a reintegrar se calcula automáticamente.',
        position: 'bottom',
      ...
      },
      {
        ...
        title: '❓ Elegir el Motivo Correcto',
        description: 'Seleccioná el motivo: Producto defectuoso/roto (reposición en garantía), Cambio de talle/color (cambio por otro ítem), El cliente no lo quiere (nota de crédito), Error de entrega (corrección). El motivo queda en reportes mensuales para detectar problemas de calidad recurrentes.',
        position: 'top',
      ...
      },
      {
        ...
        title: '✅ Qué Pasa al Confirmar',
        description: 'Al confirmar: (1) el stock vuelve automáticamente al inventario, (2) se genera nota de crédito en PDF para imprimir o enviar por mail, (3) el crédito queda registrado en la cuenta corriente del cliente para usar en próxima compra. Si el pago fue con tarjeta, gestioná el reintegro directamente con el banco.',
        position: 'top',
    ...
    steps: [
      {
        ...
        title: '📅 ¿Para Qué Sirven las Reservas?',
        description: 'Las reservas bloquean stock para un cliente que comprará más adelante. El stock reservado no está disponible para otras ventas. Usá reservas para: pedidos especiales, clientes que dejan seña, temporada alta con poca mercancía. Después se convierte en venta con un clic.',
        position: 'bottom',
        action: 'Observa las reservas activas y sus fechas de vencimiento',
      },
      {
        id: 'reservations-2',
        ...
        description: 'Hacé clic en Nueva Reserva. Completá: (1) Cliente (obligatorio), (2) producto y cantidad a reservar, (3) fecha límite de retiro, (4) si el cliente dejó seña, elegí método de pago y monto. Al guardar, el sistema bloquea esas unidades del stock inmediatamente.',
        position: 'bottom',
      ...
      },
      {
        ...
        description: 'Pendiente: el cliente aún no retiró. Para convertirla en venta, usá el botón Generar Venta dentro de la reserva: crea la venta/factura automáticamente con los datos ya cargados. Cancelada: el cliente no vino y el stock queda libre nuevamente.',
        position: 'top',
      ...
      },
      {
        ...
        description: 'Las reservas próximas a vencer aparecen en naranja; las vencidas en rojo. Al vencer, el stock queda libre automáticamente para otras ventas. Si el cliente pide más tiempo, podés extender la fecha editando la reserva. Así evitás stock bloqueado innecesariamente.',
        position: 'left',
    ...
    steps: [
      {
        ...
        title: '💬 Cómo Funciona el Sistema de Tickets',
        description: 'Cada consulta o reclamo de cliente se convierte en un ticket con número único. La lista está ordenada por prioridad y fecha. Cada ticket tiene: cliente asociado, descripción del problema, prioridad (Baja/Media/Alta/Urgente), estado actual, historial de mensajes y empleado responsable.',
        position: 'bottom',
        action: 'Observa los tickets abiertos y sus prioridades',
      },
      {
        id: 'support-2',
        ...
        description: 'Hacé clic en Nuevo Ticket. Completá: (1) Cliente que reclama, (2) asunto breve (ej: Producto con defecto de fábrica), (3) descripción detallada del problema, (4) prioridad según urgencia, (5) empleado responsable. Al guardar, el equipo recibe notificación para atenderlo.',
        position: 'bottom',
      ...
      },
      {
        ...
        title: '🚨 Cuándo Usar Cada Prioridad',
        description: 'Guía práctica: Baja (consulta general, 48-72hs), Media (problema que espera solución, 24hs), Alta (cliente enojado o afecta venta, responder hoy), Urgente (pérdida económica/reputacional, responder ahora). No abuses de Alta/Urgente o pierden su significado.',
        position: 'top',
      ...
      },
      {
        ...
        title: '✅ Cómo Resolver un Ticket',
        description: 'Para cerrar: (1) Abrí el ticket, (2) escribí en notas qué solución tomaste (ej: Se reemplazó el producto), (3) cambiá el estado a Resuelto, (4) opcionalmente notificá al cliente por email. El historial completo queda guardado para futuras referencias y auditorías.',
        position: 'top',
      ...
      },
      {
        ...
        title: '⭐ Medir la Satisfacción',
        description: 'Después de resolver, el cliente puede calificar el servicio (1-5 estrellas). El promedio del mes aparece en el panel. Una calificación de 1-2 estrellas genera alerta para revisión interna. Usá este dato para evaluar el desempeño del equipo de atención al cliente.',
        position: 'left',
    ...
    steps: [
      {
        ...
        title: '🛍️ Tu Historial de Compras a Proveedores',
        description: 'Registra TODAS las compras a proveedores: qué compraste, a quién, cuándo, a qué precio y si pagaste. Es la fuente de verdad para: (1) controlar costo de inventario, (2) negociar con proveedores, (3) declaraciones fiscales de IVA compras.',
        position: 'bottom',
        action: 'Observa las compras del mes y sus estados de pago',
      },
      {
        id: 'purchases-2',
        target: '[data-tutorial="purchases-filters"]',
        blockName: 'Filtros',
        title: '🔍 Cómo Filtrar Compras',
        description: 'Usá los filtros para encontrar compras rápido: por rango de fechas (ideal para cierres mensuales), por proveedor (para ver total comprado a cada uno), por estado (Pendiente/Pagado/Pago parcial). Combiná filtros para análisis como Todo lo que debo a Proveedor X en marzo.',
        position: 'bottom',
      ...
      },
      {
        ...
        title: '📋 Leer el Detalle de una Compra',
        description: 'Hacé clic en una compra para ver el desglose: cada producto con cantidad, precio unitario de compra, subtotal, IVA discriminado y total final. Útil para comparar vs. la factura del proveedor y verificar que cobró correctamente lo acordado.',
        position: 'top',
  ...
  // ── Devoluciones a Proveedores ────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        id: 'pret-2',
        target: '[data-tutorial="btn-create-return"]',
        blockName: 'Nueva Devolución al Proveedor',
        title: '➕ Cómo Devolver al Proveedor',
        description: 'Hacé clic en "Nueva Devolución". (1) Buscá la compra original, (2) el sistema lista los productos, (3) elegí cuáles devolverás y en qué cantidad, (4) especificá el motivo. El inventario se ajusta al confirmar.',
        position: 'bottom',
        action: 'Inicia una devolución buscando una compra reciente',
        duration: 3,
      },
      {
        id: 'pret-3',
        ...
        blockName: 'Motivo de Devolución',
        title: '❓ Elegir el Motivo Correcto',
        description: 'Seleccioná el motivo: Defectuoso/roto (el proveedor debe reponer), Vencido (venció antes del consumo), No conforme a especificación (diferente a lo pedido), Cantidad sobrante (compraste de más). El motivo es clave para documentar la reclamación y negociar.',
        position: 'top',
        action: 'Selecciona el motivo correcto para la devolución',
      },
      {
        id: 'pret-4',
    ...
    steps: [
      {
        ...
        description: 'Gestiona el ciclo completo: desde que el cliente trae el equipo hasta que lo retira con factura. Cada orden registra: cliente, equipo/problema, técnico asignado, partes usadas, tiempo trabajado y monto final.',
        position: 'bottom',
        action: 'Observa los servicios en progreso y pendientes',
      },
      {
        id: 'tech-2',
        ...
        description: 'Hacé clic en Nuevo Servicio. Completá: (1) Cliente, (2) descripción del equipo a reparar, (3) problema que reporta el cliente, (4) técnico responsable, (5) fecha estimada de entrega, (6) presupuesto aproximado si ya lo sabés. Al guardar el cliente puede recibir un número de seguimiento.',
        position: 'bottom',
      ...
      },
      {
        ...
        description: 'Nuevo (ingresó al taller) → En progreso (técnico trabajando) → En espera de partes (falta repuesto, avisá al cliente) → Listo para entregar (completó, contactá al cliente) → Entregado (retiró y pagó) / Cancelado. Actualizá el estado para que el equipo sepa el avance sin preguntar.',
        position: 'top',
    ...
    steps: [
      {
        ...
        title: '💰 Dos Tipos de Cheques',
        description: 'El módulo tiene dos registros: Cheques Emitidos (los que firmás para pagar a proveedores — dinero que sale) y Cheques Recibidos (los que clientes te entregan — dinero que entra). Cada cheque se rastrea hasta que se aclara o acredita en el banco.',
        position: 'bottom',
        action: 'Observa los dos tipos de cheques y sus estados',
      },
      {
        id: 'checks-2',
        ...
        description: 'Hacé clic en Nuevo Cheque Emitido. Completá: (1) Número de cheque (el impreso en el talonario), (2) banco y cuenta desde la que sale, (3) beneficiario (nombre del proveedor), (4) monto, (5) fecha de pago (puede ser futura para cheques diferidos). El sistema alerta 2 días antes del vencimiento.',
        position: 'bottom',
      ...
      },
      {
        ...
        description: 'Al recibir un cheque: (1) verificá firma, banco, número y monto antes de aceptarlo, (2) ingresá: titular, banco emisor, número, monto y fecha de acreditación, (3) vinculálo a la venta correspondiente. Aumenta tu saldo bancario esperado para esa fecha.',
        position: 'top',
      ...
      },
      {
        ...
        title: '⏳ Flujo de Estados del Cheque',
        description: 'Nuevo → Depositado (enviado al banco) → Acreditado (banco confirmó fondos). Si hay problemas: Rechazado (sin fondos, el sistema te permite registrar el reclamo al cliente). Actualizá el estado cuando el banco te confirme para que el saldo del sistema refleje la realidad.',
        position: 'left',
        action: 'Actualiza el estado',
      },
    ],
