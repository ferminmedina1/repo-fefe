  ...
  return (
    <Layout>
      ...
      <Card className="p-6 space-y-6">
        <div className="space-y-4" data-tutorial="notification-channels">
        ...
        <div className="space-y-4" data-tutorial="notification-types">
        ...
        <div className="space-y-4" data-tutorial="notification-frequency">
